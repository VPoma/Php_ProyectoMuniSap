            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-6 col-sm-6">
                     <ul class="lan">
                        <li><i class="" aria-hidden="true"></i>Municipalidad Distrital de Sapallanga <img src="assets/images/fleg.png" alt="#" /></li>
                     </ul>
                  </div>
                  <div class="col-md-6 col-sm-6 ">
                     <ul class="social_icon1">
                        <li> Nuestras Redes Sociales
                        </li>
      ...
      <div class="footer">
         ...
         <div class="copyright">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <p>© 2023 Todos los derechos quedan reservados.</p>
                  </div>
               </div>
            </div>
         </div>
